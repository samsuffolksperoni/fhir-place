...
export const AllergyIntoleranceStructureDefinition: StructureDefinition = {
  ...
  snapshot: {
    element: [
      ...
      { id: "AllergyIntolerance.type", path: "AllergyIntolerance.type", min: 0, max: "1", short: "allergy | intolerance - Underlying mechanism (if known)", type: [{ code: "code" }], binding: { strength: "required", valueSet: "http://hl7.org/fhir/ValueSet/allergy-intolerance-type" } },
      { id: "AllergyIntolerance.category", path: "AllergyIntolerance.category", min: 0, max: "*", short: "food | medication | environment | biologic", type: [{ code: "code" }], binding: { strength: "required", valueSet: "http://hl7.org/fhir/ValueSet/allergy-intolerance-category" } },
      { id: "AllergyIntolerance.criticality", path: "AllergyIntolerance.criticality", min: 0, max: "1", short: "low | high | unable-to-assess", type: [{ code: "code" }], binding: { strength: "required", valueSet: "http://hl7.org/fhir/ValueSet/allergy-intolerance-criticality" } },
