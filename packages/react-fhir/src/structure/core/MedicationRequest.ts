...
export const MedicationRequestStructureDefinition: StructureDefinition = {
  ...
  snapshot: {
    element: [
      ...
      { id: "MedicationRequest.category", path: "MedicationRequest.category", min: 0, max: "*", short: "Type of medication usage", type: [{ code: "CodeableConcept" }], binding: { strength: "example", valueSet: "http://hl7.org/fhir/ValueSet/medicationrequest-category" } },
