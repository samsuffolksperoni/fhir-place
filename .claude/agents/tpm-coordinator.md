...
3. For ship-readiness checks, run the punch list:
   ...
   - **Live UAT walked against `https://samsuffolksperoni.github.io/fhir-place/staging/` and signed off** — without this, the change is not ready for `staging -> main` promotion
